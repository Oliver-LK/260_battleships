...
game.out: game.o system.o display.o led.o set_up.o ledmat.o navswitch.o pacer.o ir_uart.o tinygl.o pio.o ship_mod.o attack.o test_case.o led_testing.o timer.o timer0.o button.o usart1.o font.o prescale.o ir_uart.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
